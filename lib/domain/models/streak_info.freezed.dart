...
mixin _$StreakInfo {
 ...
 int get routineId; String get routineName; int get currentStreak; int get bestStreak;
...
@override
int get hashCode => Object.hash(runtimeType,routineId,routineName,currentStreak,bestStreak);

@override
String toString() {
  return 'StreakInfo(routineId: $routineId, routineName: $routineName, currentStreak: $currentStreak, bestStreak: $bestStreak)';
}
...
@useResult
$Res call({
 int routineId, String routineName, int currentStreak, int bestStreak
});
...
/// Create a copy of StreakInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? routineId = null,Object? routineName = null,Object? currentStreak = null,Object? bestStreak = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int routineId,  String routineName,  int currentStreak,  int bestStreak)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StreakInfo() when $default != null:
return $default(_that.routineId,_that.routineName,_that.currentStreak,_that.bestStreak);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int routineId,  String routineName,  int currentStreak,  int bestStreak)  $default,) {final _that = this;
switch (_that) {
case _StreakInfo():
return $default(_that.routineId,_that.routineName,_that.currentStreak,_that.bestStreak);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int routineId,  String routineName,  int currentStreak,  int bestStreak)?  $default,) {final _that = this;
switch (_that) {
case _StreakInfo() when $default != null:
return $default(_that.routineId,_that.routineName,_that.currentStreak,_that.bestStreak);case _:
  return null;
...
class _StreakInfo implements StreakInfo {
  const _StreakInfo({required this.routineId, required this.routineName, required this.currentStreak, required this.bestStreak});
...
/// Create a copy of StreakInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? routineId = null,Object? routineName = null,Object? currentStreak = null,Object? bestStreak = null,}) {
